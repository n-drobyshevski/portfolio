    ...
    <div className="flex h-full items-center gap-8">
      <div className="flex grow-0 basis-1/2 flex-col gap-4 text-neutral-400">
        ...
        <p>
          ...
          Id tempor pretium, facilisis ut euismod eget volutpat. Maecenas mauris
          tortor eu nam. Elit sed tellus non sed adipiscing. Amet, nibh enim
          tincidunt porttitor. Pulvinar mattis maecenas enim suspendisse
          condimentum facilisi aliquam. Eu tristique metus urna, orci hendrerit
          leo. Feugiat id pharetra sed at amet felis augue pulvinar id. Dolor,
          morbi massa pretium etiam urna, ut ac.
        </p>
      </div>
